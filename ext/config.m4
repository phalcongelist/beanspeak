...
if test "$PHP_BEANSPEAK" = "yes"; then
	...
	beanspeak/command/ignore.zep.c
	beanspeak/command/kick.zep.c
	beanspeak/command/kickjob.zep.c
	beanspeak/command/listtubes.zep.c
	beanspeak/command/listtubeswatched.zep.c
	beanspeak/command/listtubeused.zep.c
	beanspeak/command/pausetube.zep.c
	beanspeak/command/peek.zep.c
	beanspeak/command/put.zep.c
	beanspeak/command/quit.zep.c
	beanspeak/command/release.zep.c
