...
PHP_METHOD(Beanspeak_Dispatcher, __construct) {
	...
	if (!(zephir_is_true(connection))) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 29);
...
void zep_Beanspeak_Dispatcher__reconnect(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used TSRMLS_DC) {
	...
	ZEPHIR_CALL_METHOD(NULL, newc, "__construct", NULL, 29, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, newc, "connect", NULL, 30);
	zephir_check_call_status();
...
void zep_Beanspeak_Dispatcher_parseData(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used TSRMLS_DC) {
	...
	zend_bool _0, _1;
	zval *connection = NULL, *dataLength = NULL, *data = NULL, *crlf = NULL, *response = NULL, *_2$$3 = NULL, *_3$$3, *_4$$3, _5$$3, *_6$$4, *_7$$4, *_8$$4 = NULL, *_9$$4;
	int ZEPHIR_LAST_CALL_STATUS;
	...
	if (_1) {
		...
		ZEPHIR_CALL_FUNCTION(&dataLength, "preg_replace", NULL, 21, _2$$3, _3$$3, response);
