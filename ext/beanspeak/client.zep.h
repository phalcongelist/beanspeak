...
ZEND_BEGIN_ARG_INFO_EX(arginfo_beanspeak_client_watchonly, 0, 0, 1)
	ZEND_ARG_INFO(0, tube)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_beanspeak_client_reserve, 0, 0, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_beanspeak_client_listtubeswatched, 0, 0, 0)
	ZEND_ARG_INFO(0, ask)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(beanspeak_client_method_entry) {
	...
	PHP_ME(Beanspeak_Client, listTubesWatched, arginfo_beanspeak_client_listtubeswatched, ZEND_ACC_PUBLIC)
