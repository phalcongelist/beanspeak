...
PHP_METHOD(Beanspeak_Client, ignore) {
	...
	zend_bool _3$$4;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *tube_param = NULL, response, watchedTubes, _0, _2$$4, _4$$4, _5$$6, _6$$6, _7$$6;
	zval tube, _1$$4;
	ZEPHIR_INIT_THIS();
	...
	zephir_read_property(&_0, this_ptr, SL("watchedTubes"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&watchedTubes, &_0);
	if (Z_TYPE_P(&watchedTubes) != IS_ARRAY) {
		RETURN_THIS();
	}
	if (zephir_array_isset(&watchedTubes, &tube)) {
		ZEPHIR_INIT_VAR(&_1$$4);
		ZEPHIR_CONCAT_SV(&_1$$4, "ignore ", &tube);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "write", NULL, 0, &_1$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&response, this_ptr, "readstatus", NULL, 6);
		zephir_check_call_status();
		zephir_array_fetch_long(&_2$$4, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 514 TSRMLS_CC);
		if (ZEPHIR_IS_STRING(&_2$$4, "NOT_IGNORED")) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Cannot ignore last tube in watchlist.", "beanspeak/client.zep", 515);
			return;
		}
		_3$$4 = !(zephir_array_isset_long(&response, 1));
		if (!(_3$$4)) {
			zephir_array_fetch_long(&_4$$4, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 518 TSRMLS_CC);
			_3$$4 = !ZEPHIR_IS_STRING(&_4$$4, "WATCHING");
		}
		if (_3$$4) {
			ZEPHIR_INIT_VAR(&_5$$6);
			object_init_ex(&_5$$6, beanspeak_exception_ce);
			ZEPHIR_INIT_VAR(&_6$$6);
			zephir_fast_join_str(&_6$$6, SL(" "), &response TSRMLS_CC);
			ZEPHIR_INIT_VAR(&_7$$6);
			ZEPHIR_CONCAT_SV(&_7$$6, "Unhandled response: ", &_6$$6);
			ZEPHIR_CALL_METHOD(NULL, &_5$$6, "__construct", NULL, 3, &_7$$6);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_5$$6, "beanspeak/client.zep", 519 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Beanspeak_Client, statsTube) {
	...
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 9);
	zephir_check_call_status();
	zephir_array_fetch_long(&_1, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 564 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(&_1, "OK")) {
		RETURN_MM_BOOL(0);
	}
	zephir_array_fetch_long(&_2, &response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 568 TSRMLS_CC);
	RETURN_CTOR(_2);
...
PHP_METHOD(Beanspeak_Client, listTubes) {
	...
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 9);
	zephir_check_call_status();
	zephir_array_fetch_long(&_1, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 585 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(&_1, "OK")) {
		RETURN_MM_BOOL(0);
	}
	zephir_array_fetch_long(&_2, &response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 589 TSRMLS_CC);
	RETURN_CTOR(_2);
...
PHP_METHOD(Beanspeak_Client, listTubeUsed) {
	...
	_1 = zephir_array_isset_long(&response, 1);
	if (_1) {
		zephir_array_fetch_long(&_2, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 614 TSRMLS_CC);
		_1 = ZEPHIR_IS_STRING(&_2, "USING");
	}
	if (_1) {
		zephir_array_fetch_long(&_3$$4, &response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 615 TSRMLS_CC);
		zephir_update_property_zval(this_ptr, SL("usedTube"), &_3$$4);
		zephir_array_fetch_long(&_4$$4, &response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 616 TSRMLS_CC);
		RETURN_CTOR(_4$$4);
	}
	ZEPHIR_INIT_NVAR(&_0);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "beanspeak/client.zep", 619 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Beanspeak_Client, listTubesWatched) {
	...
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 9);
	zephir_check_call_status();
	zephir_array_fetch_long(&_2, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 643 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(&_2, "OK")) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$4, "beanspeak/client.zep", 644 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_array_fetch_long(&_6, &response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 647 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, pauseTube) {
	...
	if (!(_2)) {
		zephir_array_fetch_long(&_3, &response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 666 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, write) {
	...
	if (!(zephir_is_true(&_0))) {
		...
		if (!(zephir_is_true(&_2$$3))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Unable to establish connection with beanstalkd server.", "beanspeak/client.zep", 713);
			return;
		}
	}
	zephir_read_property(&_3, this_ptr, SL("options"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_OBS_VAR(&retries);
	zephir_array_fetch_string(&retries, &_3, SL("wretries"), PH_NOISY, "beanspeak/client.zep", 717 TSRMLS_CC);
	...
	while (1) {
		...
		if (_5$$5) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_6$$6, "beanspeak/client.zep", 729 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Beanspeak_Client, read) {
	...
	if (length) {
		if (zephir_feof(&socket TSRMLS_CC)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Failed to read data from socket (EOF).", "beanspeak/client.zep", 759);
			return;
		}
		...
		zephir_check_call_status();
		zephir_array_fetch_string(&_6$$5, &meta, SL("timed_out"), PH_NOISY | PH_READONLY, "beanspeak/client.zep", 765 TSRMLS_CC);
		if (zephir_is_true(&_6$$5)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Connection timed out upon attempt to read data from socket.", "beanspeak/client.zep", 766);
			return;
		}
		if (ZEPHIR_IS_FALSE_IDENTICAL(&data)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Failed to read data from socket.", "beanspeak/client.zep", 770);
			return;
		}
	...
	if (zephir_array_isset(&errors, &data)) {
		...
		zephir_array_fetch(&_12$$10, &errors, &data, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 786 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, &_11$$10, "__construct", NULL, 3, &_12$$10);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_11$$10, "beanspeak/client.zep", 786 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(data);
...
PHP_METHOD(Beanspeak_Client, readYaml) {
	...
	if (zephir_array_isset_long(&response, 0)) {
		ZEPHIR_OBS_VAR(&status);
		zephir_array_fetch_long(&status, &response, 0, PH_NOISY, "beanspeak/client.zep", 802 TSRMLS_CC);
	} else {
	...
	if (zephir_array_isset_long(&response, 1)) {
		...
		zephir_array_fetch_long(&bytes, &response, 1, PH_NOISY, "beanspeak/client.zep", 808 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, yamlParse) {
	...
	if (_3) {
		zephir_array_fetch_long(&_4, &lines, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 852 TSRMLS_CC);
	...
	zephir_is_iterable(&lines, 0, "beanspeak/client.zep", 888);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&lines), _9, _10, _8)
	{
		...
		if (zephir_start_with_str(&value, SL("-"))) {
			...
			if (!(zephir_array_isset_long(&values, 1))) {
				...
				ZEPHIR_OBS_NVAR(&key);
				zephir_array_fetch_long(&key, &values, 0, PH_NOISY, "beanspeak/client.zep", 870 TSRMLS_CC);
				zephir_array_fetch_long(&_18$$11, &values, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 871 TSRMLS_CC);
