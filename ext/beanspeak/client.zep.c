...
PHP_METHOD(Beanspeak_Client, connect) {
	...
	HashTable *_20;
	HashPosition _19;
	zval *e = NULL, *options = NULL, *socket = NULL, *usedTube = NULL, *watchedTubes = NULL, *tube = NULL, *_0 = NULL, *_1, _17, *_18 = NULL, **_21, *_2$$4, *_3$$5, *_4$$5, *_5$$5, *_6$$5, *_7$$5, *_8$$6, *_9$$6, *_10$$6, *_11$$6, *_12$$6, *_13$$7, *_14$$7, *_15$$8, *_16$$8 = NULL, *_22$$11, *_24$$12;
	...
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("watchedTubes"), PH_NOISY_CC);
	ZEPHIR_CPY_WRT(watchedTubes, _1);
	...
	ZEPHIR_INIT_VAR(_18);
	zephir_is_iterable(watchedTubes, &_20, &_19, 0, 0, "beanspeak/client.zep", 139);
	for (
	  ; zephir_hash_get_current_data_ex(_20, (void**) &_21, &_19) == SUCCESS
	  ; zephir_hash_move_forward_ex(_20, &_19)
	) {
		ZEPHIR_GET_HMKEY(tube, _20, _19);
		ZEPHIR_GET_HVALUE(_18, _21);
		if (!ZEPHIR_IS_STRING(tube, "default")) {
			_22$$11 = zephir_fetch_nproperty_this(this_ptr, SL("watchedTubes"), PH_NOISY_CC);
			zephir_array_unset(&_22$$11, tube, PH_SEPARATE);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "watch", &_23, 0, tube);
			zephir_check_call_status();
		}
	}
	if (!(zephir_array_isset_string(watchedTubes, SS("default")))) {
		ZEPHIR_INIT_VAR(_24$$12);
		ZVAL_STRING(_24$$12, "default", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "ignore", NULL, 0, _24$$12);
		zephir_check_temp_parameter(_24$$12);
		zephir_check_call_status();
	}
	RETURN_CCTOR(socket);
...
PHP_METHOD(Beanspeak_Client, disconnect) {
	...
	if (!(zephir_is_true(status))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Failed to close connection.", "beanspeak/client.zep", 174);
		return;
	}
	zephir_update_property_this(this_ptr, SL("socket"), ZEPHIR_GLOBAL(global_null) TSRMLS_CC);
	ZEPHIR_INIT_ZVAL_NREF(_1);
	ZVAL_STRING(_1, "default", 1);
	zephir_update_property_this(this_ptr, SL("usedTube"), _1 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_2);
	zephir_create_array(_2, 1, 0 TSRMLS_CC);
	zephir_array_update_string(&_2, SL("default"), &ZEPHIR_GLOBAL(global_true), PH_COPY | PH_SEPARATE);
	zephir_update_property_this(this_ptr, SL("watchedTubes"), _2 TSRMLS_CC);
	RETURN_MM_BOOL(1);
...
PHP_METHOD(Beanspeak_Client, put) {
	...
	if (zephir_array_isset_long(response, 1)) {
		zephir_array_fetch_long(&status, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 218 TSRMLS_CC);
		...
		if (_4$$3) {
			ZEPHIR_OBS_VAR(_5$$4);
			zephir_array_fetch_long(&_5$$4, response, 1, PH_NOISY, "beanspeak/client.zep", 221 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, useTube) {
	...
	if (_1) {
		zephir_array_fetch_long(&_2, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 279 TSRMLS_CC);
		_1 = ZEPHIR_IS_STRING(_2, "USING");
	}
	if (_1) {
		ZEPHIR_OBS_VAR(status);
		zephir_array_fetch_long(&status, response, 0, PH_NOISY, "beanspeak/client.zep", 280 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(_3, "beanspeak/client.zep", 290 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Beanspeak_Client, peekJob) {
	...
	if (_2) {
		zephir_array_fetch_long(&_3, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 307 TSRMLS_CC);
		_2 = ZEPHIR_IS_STRING(_3, "FOUND");
	}
	if (_2) {
		object_init_ex(return_value, beanspeak_job_ce);
		zephir_array_fetch_long(&_4$$3, response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 308 TSRMLS_CC);
		zephir_array_fetch_long(&_6$$3, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 308 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, peekDelayed) {
	...
	if (_1) {
		zephir_array_fetch_long(&_2, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 328 TSRMLS_CC);
		_1 = ZEPHIR_IS_STRING(_2, "FOUND");
	}
	if (_1) {
		object_init_ex(return_value, beanspeak_job_ce);
		zephir_array_fetch_long(&_3$$3, response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 329 TSRMLS_CC);
		zephir_array_fetch_long(&_5$$3, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 329 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, peekBuried) {
	...
	_1 = zephir_array_isset_long(response, 2);
	if (_1) {
		zephir_array_fetch_long(&_2, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 349 TSRMLS_CC);
		_1 = ZEPHIR_IS_STRING(_2, "FOUND");
	}
	if (_1) {
		object_init_ex(return_value, beanspeak_job_ce);
		zephir_array_fetch_long(&_3$$3, response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 350 TSRMLS_CC);
		zephir_array_fetch_long(&_5$$3, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 350 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "read", NULL, 0, _5$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_6$$3, "unserialize", NULL, 7, _4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Beanspeak_Client, peekReady) {
	...
	_1 = zephir_array_isset_long(response, 2);
	if (_1) {
		zephir_array_fetch_long(&_2, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 370 TSRMLS_CC);
		_1 = ZEPHIR_IS_STRING(_2, "FOUND");
	}
	if (_1) {
		object_init_ex(return_value, beanspeak_job_ce);
		zephir_array_fetch_long(&_3$$3, response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 371 TSRMLS_CC);
		zephir_array_fetch_long(&_5$$3, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 371 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "read", NULL, 0, _5$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_6$$3, "unserialize", NULL, 7, _4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Beanspeak_Client, kick) {
	...
	if (_2) {
		zephir_array_fetch_long(&_3, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 392 TSRMLS_CC);
		_2 = ZEPHIR_IS_STRING(_3, "KICKED");
	}
	if (_2) {
		ZEPHIR_OBS_VAR(_4$$3);
		zephir_array_fetch_long(&_4$$3, response, 1, PH_NOISY, "beanspeak/client.zep", 393 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, watch) {
	...
	zend_bool _2$$3;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *tube_param = NULL, *response = NULL, *watchedTubes = NULL, *_0, *_3$$3, *_4$$4, *_5$$4, *_6$$4;
	zval *tube = NULL, *_1$$3;
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("watchedTubes"), PH_NOISY_CC);
	...
	if (!(zephir_array_isset(watchedTubes, tube))) {
		...
		if (!(_2$$3)) {
			zephir_array_fetch_long(&_3$$3, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 417 TSRMLS_CC);
		...
		if (_2$$3) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_4$$4, "beanspeak/client.zep", 418 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_update_property_array(this_ptr, SL("watchedTubes"), tube, ZEPHIR_GLOBAL(global_true) TSRMLS_CC);
	}
	RETURN_THIS();
...
PHP_METHOD(Beanspeak_Client, watchOnly) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *tube_param = NULL, *watchedTubes = NULL, *watchedTube = NULL, *_0, *_1 = NULL, **_4;
	zval *tube = NULL;
	...
	ZEPHIR_CPY_WRT(watchedTubes, _0);
	ZEPHIR_INIT_VAR(_1);
	zephir_is_iterable(watchedTubes, &_3, &_2, 0, 0, "beanspeak/client.zep", 452);
	for (
	  ; zephir_hash_get_current_data_ex(_3, (void**) &_4, &_2) == SUCCESS
	  ; zephir_hash_move_forward_ex(_3, &_2)
	) {
		ZEPHIR_GET_HMKEY(watchedTube, _3, _2);
...
PHP_METHOD(Beanspeak_Client, ignore) {
	...
	zend_bool _3$$3;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *tube_param = NULL, *response = NULL, *watchedTubes = NULL, *_0, *_2$$3, *_4$$3, *_5$$5, *_6$$5, *_7$$5;
	zval *tube = NULL, *_1$$3;
	...
	if (zephir_array_isset(watchedTubes, tube)) {
		...
		ZEPHIR_CALL_METHOD(&response, this_ptr, "readstatus", NULL, 6);
		zephir_check_call_status();
		zephir_array_fetch_long(&_2$$3, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 474 TSRMLS_CC);
		if (ZEPHIR_IS_STRING(_2$$3, "NOT_IGNORED")) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Cannot ignore last tube in watchlist.", "beanspeak/client.zep", 475);
			return;
		}
		_3$$3 = !(zephir_array_isset_long(response, 1));
		if (!(_3$$3)) {
			zephir_array_fetch_long(&_4$$3, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 478 TSRMLS_CC);
		...
		if (_3$$3) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_5$$5, "beanspeak/client.zep", 479 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_array_unset(&watchedTubes, tube, PH_SEPARATE);
		zephir_update_property_this(this_ptr, SL("watchedTubes"), watchedTubes TSRMLS_CC);
	}
	RETURN_THIS();
...
PHP_METHOD(Beanspeak_Client, stats) {
	...
	zephir_check_call_status();
	zephir_array_fetch_long(&_1, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 503 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(_1, "OK")) {
		RETURN_MM_BOOL(0);
	}
	zephir_array_fetch_long(&_2, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 507 TSRMLS_CC);
	RETURN_CTOR(_2);
...
PHP_METHOD(Beanspeak_Client, statsTube) {
	...
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 9);
	zephir_check_call_status();
	zephir_array_fetch_long(&_1, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 524 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(_1, "OK")) {
		RETURN_MM_BOOL(0);
	}
	zephir_array_fetch_long(&_2, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 528 TSRMLS_CC);
	RETURN_CTOR(_2);
...
PHP_METHOD(Beanspeak_Client, listTubes) {
	...
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 9);
	zephir_check_call_status();
	zephir_array_fetch_long(&_1, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 545 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(_1, "OK")) {
		RETURN_MM_BOOL(0);
	}
	zephir_array_fetch_long(&_2, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 549 TSRMLS_CC);
	RETURN_CTOR(_2);
...
PHP_METHOD(Beanspeak_Client, listTubeUsed) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *ask_param = NULL, *response = NULL, *_0 = NULL, *_2, *_5, *_6, *_3$$4, *_4$$4;
	zend_bool ask, _1;
	...
	_1 = zephir_array_isset_long(response, 1);
	if (_1) {
		zephir_array_fetch_long(&_2, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 574 TSRMLS_CC);
		_1 = ZEPHIR_IS_STRING(_2, "USING");
	}
	if (_1) {
		zephir_array_fetch_long(&_3$$4, response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 575 TSRMLS_CC);
		zephir_update_property_this(this_ptr, SL("usedTube"), _3$$4 TSRMLS_CC);
		zephir_array_fetch_long(&_4$$4, response, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 576 TSRMLS_CC);
		RETURN_CTOR(_4$$4);
	}
	ZEPHIR_INIT_NVAR(_0);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(_0, "beanspeak/client.zep", 579 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Beanspeak_Client, listTubesWatched) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *ask_param = NULL, *response = NULL, *_1, *_2, *_6, *_7 = NULL, *_0$$3, *_3$$4, *_4$$4, *_5$$4;
	zend_bool ask;
	...
	if (!(ask)) {
		_0$$3 = zephir_fetch_nproperty_this(this_ptr, SL("watchedTubes"), PH_NOISY_CC);
	...
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 9);
	zephir_check_call_status();
	zephir_array_fetch_long(&_2, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 603 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(_2, "OK")) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_3$$4, "beanspeak/client.zep", 604 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_array_fetch_long(&_6, response, 2, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 607 TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_7, "array_fill_keys", NULL, 10, _6, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("watchedTubes"), _7 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, pauseTube) {
	...
	if (!(_2)) {
		zephir_array_fetch_long(&_3, response, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 626 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, write) {
	...
	if (!(zephir_is_true(_0))) {
		...
		if (!(zephir_is_true(_2$$3))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Unable to establish connection with beanstalkd server.", "beanspeak/client.zep", 673);
			return;
		}
	}
	_3 = zephir_fetch_nproperty_this(this_ptr, SL("options"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(retries);
	zephir_array_fetch_string(&retries, _3, SL("wretries"), PH_NOISY, "beanspeak/client.zep", 677 TSRMLS_CC);
	...
	while (1) {
		...
		if (_5$$5) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_6$$6, "beanspeak/client.zep", 689 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Beanspeak_Client, read) {
	...
	if (length) {
		if (zephir_feof(socket TSRMLS_CC)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Failed to read data from socket (EOF).", "beanspeak/client.zep", 719);
			return;
		}
		...
		zephir_check_call_status();
		zephir_array_fetch_string(&_6$$5, meta, SL("timed_out"), PH_NOISY | PH_READONLY, "beanspeak/client.zep", 725 TSRMLS_CC);
		if (zephir_is_true(_6$$5)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Connection timed out upon attempt to read data from socket.", "beanspeak/client.zep", 726);
			return;
		}
		if (ZEPHIR_IS_FALSE_IDENTICAL(data)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(beanspeak_exception_ce, "Failed to read data from socket.", "beanspeak/client.zep", 730);
			return;
		}
		ZEPHIR_INIT_VAR(_7$$5);
		...
		ZVAL_STRING(&_9$$9, "\r\n", 0);
		ZEPHIR_CALL_FUNCTION(&data, "stream_get_line", &_5, 11, socket, &_8$$9, &_9$$9);
		zephir_check_call_status();
	}
	...
	if (zephir_array_isset(errors, data)) {
		...
		zephir_array_fetch(&_11$$10, errors, data, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 746 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, _10$$10, "__construct", NULL, 3, _11$$10);
		zephir_check_call_status();
		zephir_throw_exception_debug(_10$$10, "beanspeak/client.zep", 746 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(data);
...
PHP_METHOD(Beanspeak_Client, readYaml) {
	...
	if (zephir_array_isset_long(response, 0)) {
		ZEPHIR_OBS_VAR(status);
		zephir_array_fetch_long(&status, response, 0, PH_NOISY, "beanspeak/client.zep", 762 TSRMLS_CC);
	} else {
	...
	if (zephir_array_isset_long(response, 1)) {
		...
		zephir_array_fetch_long(&bytes, response, 1, PH_NOISY, "beanspeak/client.zep", 768 TSRMLS_CC);
...
PHP_METHOD(Beanspeak_Client, yamlParse) {
	...
	if (_3) {
		zephir_array_fetch_long(&_4, lines, 0, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 812 TSRMLS_CC);
	...
	zephir_is_iterable(lines, &_9, &_8, 0, 0, "beanspeak/client.zep", 848);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_9, &_8)
		...
		if (zephir_start_with_str(value, SL("-"))) {
			...
			if (!(zephir_array_isset_long(values, 1))) {
				...
				ZEPHIR_OBS_NVAR(key);
				zephir_array_fetch_long(&key, values, 0, PH_NOISY, "beanspeak/client.zep", 830 TSRMLS_CC);
				zephir_array_fetch_long(&_18$$11, values, 1, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 831 TSRMLS_CC);
...
static zend_object_value zephir_init_properties_Beanspeak_Client(zend_class_entry *class_type TSRMLS_DC) {
	...
	
	{
		...
		if (Z_TYPE_P(_0) == IS_NULL) {
			...
			zephir_array_update_string(&_1$$3, SL("default"), &ZEPHIR_GLOBAL(global_true), PH_COPY | PH_SEPARATE);
			zephir_update_property_this(this_ptr, SL("watchedTubes"), _1$$3 TSRMLS_CC);
		}
		_2 = zephir_fetch_nproperty_this(this_ptr, SL("options"), PH_NOISY_CC);
		if (Z_TYPE_P(_2) == IS_NULL) {
			ZEPHIR_INIT_VAR(_3$$4);
			array_init(_3$$4);
			zephir_update_property_this(this_ptr, SL("options"), _3$$4 TSRMLS_CC);
		}
		ZEPHIR_MM_RESTORE();
