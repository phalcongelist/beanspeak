...
PHP_METHOD(Beanspeak_Client, read) {
	...
	if (zephir_array_isset(&errors, &data)) {
		...
		zephir_array_fetch(&_12$$10, &errors, &data, PH_NOISY | PH_READONLY, "beanspeak/client.zep", 736 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, &_11$$10, "__construct", NULL, 3, &_12$$10);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_11$$10, "beanspeak/client.zep", 736 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(data);
...
PHP_METHOD(Beanspeak_Client, yamlParse) {
	...
	zephir_is_iterable(&lines, 0, "beanspeak/client.zep", 838);
